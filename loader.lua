...
local url = script_details.debug and "http://localhost:6845" or "https://raw.githubusercontent.com/RensPhantom/Rens-Phantom-Hack/main"

local out = script_details.debug and function(T, ...)
    return warn("[rens phantom hack - debug]: "..T:format(...))
end or function() end
